...
;( function( RHLApp, window, document, $, undefined ){
	...
	String.prototype.init = function( options ){

		this.settings = settings = $.extend({}, defaults, options)

		return this
	}
	String.prototype.to = function( strString, strConvertTo ){

		switch( strConvertTo ){
			case 'slug':
				strString = strString.toString().toLowerCase().trim()
